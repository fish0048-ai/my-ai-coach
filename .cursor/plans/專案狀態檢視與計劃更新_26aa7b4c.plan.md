...
| 3D／2D 虛擬世界：美術與應用性提升          | 📋 待處理 |


---

## 🎨 新任務：3D／2D 虛擬世界美術與實際應用性提升

**Todo ID**：`world-art-ux`  
**現況**：WorldView、World3DView、World2DView 與 world3dConfig 已可運作，但視覺與互動仍偏陽春，需強化美術與實際應用性。
...
| 面向      | 說明與可做項目                                                      |
| ------- | ------------------------------------------------------------ |
| **美術**  | 建築／地景造型區分度、材質／光影、天空／環境、2D 等角圖示與配色統一、品牌感（Modern Fitness Dark） |
| **應用性** | 建築名稱／功能提示（hover／tooltip）、進入建築的過場或回饋、地圖縮放／視角、快捷入口（從世界一鍵進常用功能） |
| **體驗**  | 載入狀態、空狀態、無障礙（鍵盤／焦點、替代文字）、效能（3D 物件數、LOD 或簡化）                  |
