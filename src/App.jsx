...
const BODY_PATHS = {
    front: {
        ...
        abs: "M42,65 L58,65 L56,90 L44,90 Z M42,72 H58 M43,80 H57", 
    ...
    back: {
        head: "M50,15 C50,15 58,15 58,23 C58,31 56,36 50,36 C44,36 42,31 42,23 C42,15 50,15 50,15 Z",
        traps: "M44,40 L56,40 L65,48 L50,60 L35,48 Z",
        lats_left: "M35,48 L40,65 L50,85 L50,60 L40,55 Z",
        lats_right: "M65,48 L60,65 L50,85 L50,60 L60,55 Z",
        lower_back: "M42,85 L58,85 L56,92 L44,92 Z",
...
const ICONS = {
  ...
  save: <path d="M15.2 3a2 2 0 0 1 1.4.6l3.8 3.
  import React, { useState, useEffect, useRef, useMemo } from 'react';
  ...
  export default App;
  8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z" />,
  loader2: <path d="M21 12a9 9 0 1 1-6.219-8.56" />,
  alertcircle: <><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></>,
  usercircle: <><circle cx="12" cy="12" r="10"/><circle cx="12" cy="10" r="3"/><path d="M7 20.662V19a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v1.662"/></>,
  checkcircle2: <><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></>,
