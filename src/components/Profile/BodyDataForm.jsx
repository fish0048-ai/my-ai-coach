      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <input 
            ...
            disabled={!isEditing}
            onChange={(e) => onProfileChange({...profile, height: e.target.value})}
        ...
        <div className="space-y-2">
          ...
          <input 
            ...
            disabled={!isEditing}
            onChange={(e) => onProfileChange({...profile, weight: e.target.value})}
            className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-blue-500 outline-none disabled:opacity-50"
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <input 
            ...
            disabled={!isEditing}
            onChange={(e) => onProfileChange({...profile, bodyFat: e.target.value})}
            className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-blue-500 outline-none disabled:opacity-50"
            placeholder="例如: 18.5"
          />
        </div>
